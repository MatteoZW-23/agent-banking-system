    ...
    <DashboardLayout>
      <div className="space-y-12 animate-fade-in pb-20 px-4 lg:px-0">
        ...
        <PageHeader
          ...
          subtitle="Configure core payment gateways, SMS routing, and enterprise security protocols."
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <Card className="border-none shadow-sm dark:bg-slate-900/50 rounded-[2.5rem] overflow-hidden group">
                <CardHeader className="pt-10 px-10 pb-6">
                  ...
                  <CardDescription className="text-xs uppercase font-bold text-slate-400 tracking-[0.2em] italic">
                    Identity nodes for receipts & reporting
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="border-none shadow-sm dark:bg-slate-900/50 rounded-[2.5rem] overflow-hidden group">
                <CardHeader className="pt-10 px-10 pb-6">
                  ...
                  <CardDescription className="text-xs uppercase font-bold text-slate-400 tracking-[0.2em] italic">
                    Currency & date localized telemetry
                  </CardDescription>
                </CardHeader>
                <CardContent className="px-10 pb-12 space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <span className="flex items-center gap-4">
                          <Lock className="w-4 h-4 text-primary" /> Modify
                          Global Password
                        </span>
