    ...
    <Dialog open={isOpen}>
      <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col p-0 overflow-hidden border-none shadow-2xl bg-white dark:bg-slate-950">
        ...
        <div className="flex-1 overflow-hidden flex flex-col px-8 py-6">
          <div className="flex items-center gap-3 mb-6 p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-xl">
        ...
        <DialogFooter className="px-8 pb-8 pt-0">
          <Button
            ...
            className="w-full h-12 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-base shadow-lg shadow-blue-500/20 disabled:opacity-50 transition-all"
          >
